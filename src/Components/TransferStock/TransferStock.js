...
function TransferStock({ details_data, stocknum, setAllPro, ...props }) {
    ...
    const onSubmit = async (values, { resetForm }) => {
        ...
        if(Status) {
            await axios.put('https://storecontrolserver-production.up.railway.app/product/edit', edit_val)
            await axios.put('https://storecontrolserver-production.up.railway.app/product/edit', main_pro)
        }
